...
const FeaturedBadge = ({type, variant = 'badge', title, ...p}: Props) => {
  const tooltipTitle = title === undefined ? defaultTitles[type] : title;

  return (
    <div {...p}>
      <Tooltip title={tooltipTitle} disabled={!tooltipTitle} position="right">
        <React.Fragment>
